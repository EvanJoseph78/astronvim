...
maps.n["<C-pageDown>"] = ":bnext<CR>"
maps.n["<C-pageUp>"] = ":bprevious<CR>"
vim.keymap.set("i", "<C-pageDown>", "<Esc>:bprevious<CR>")
vim.keymap.set("i", "<C-pageUp>", "<Esc>:bnext<CR>")
vim.keymap.set("v", "<C-pageDown>", "<Esc>:bprevious<CR>")
vim.keymap.set("v", "<C-pageUp>", "<Esc>:bnext<CR>")
